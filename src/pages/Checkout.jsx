...
const Checkout = () => {
  return (
    ...
    <Container className={'max-w-headerContainer py-[120px]'}>
        ...
        <div>
          <Heading as={'h3'} className={'text-TextHColor text-[49px] font-dms font-bold mobile:text-center'} text={'Checkout'} />
        ...
        <div className='pt-[100px]'>
          <Text className={'font-dms text-TextColor text-[16px] pr-[545px] android:pr-[290px] pb-[50px] mobile:px-10 '} text={"Have a coupon? Click here to enter your code"} />
        </div>
        ...
        <div className='pt-[100px] w-2/3 mobile:w-full'>
          <Text className={'font-dms font-bold text-TextHColor text-[39px] mobile:text-[27px]'} text={"Additional Information"} />
          <div className='pt-[25px]'>
        ...
        <div className='pt-[100px]'>
          ...
          <table class="border w-1/2 mt-[50px] mobile:w-full">
        ...
        <div className='w-2/3 border p-[30px] mt-[60px] mobile:w-full'>
          <div>
          ...
          <Anchor href={'#'}>
            <button className={'font-dms font-bold text-[14px] text-white bg-black inline-block py-4 px-[70px] mt-8 mobile:px-[63px]'} type='button'>Proceed to Bank</button>
        </Anchor>
        </div>
